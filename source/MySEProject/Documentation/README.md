...
After running this project, we got the following [experiment_output](https://github.com/sohelranalive/neocortexapi-CodeHive/blob/master/source/MySEProject/AnomalyDetectionSample/ResultVisualizer/experiment_results.txt).
